...
一条存储运维工程师的成长路线，在线交互式，没有分岔：弄懂存储在说什么，
学会读机器给的信号，亲手把集群跑起来、扛住它出的每一次故障，
...
排序有两条原则。**先建立语言，再学会测量**：连「块 / 文件 / 对象」都分不清，去读 iostat
就找不到落点。**先跑起来，再讲原理**：L2 把 cephadm 部署提到 CRUSH/PG 之前，

...
没有基线的调优都是玄学。这一节不打算给你一堆参数，只讲怎么证明自己改的东西真有效。
...
MTU 9000、public/cluster 分离、重传率检查前面几节都讲过了，这里只补一条：
...
<Quiz
  ...
  explain={<>
    裸盘快而 RADOS 慢，说明瓶颈在盘之上的环节，网络、副本复制、OSD 进程的 CPU/内存都得查。分层基线的用处就在这。
